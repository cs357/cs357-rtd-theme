    ...
    generatePDFObjectMarkup = function (
      ...
      return (
        customAttribute &&
          ...
          el.setAttribute(
            customAttribute.key,
            void 0 !== customAttribute.value ? customAttribute.value : ""
          ),
      ...
      if (
        ...
        (pdfOpenFragment = (function (pdfParams) {
          let prop,
            ...
            fdf = "";
          if (
            ((pdfParams.comment || pdfParams.viewrect || pdfParams.highlight) &&
              (pdfParams.page ||
                ((pdfParams.page = 1),
                embedError(
            ...
            pdfParams.fdf && ((fdf = pdfParams.fdf), delete pdfParams.fdf),
            pdfParams)
          ) {
            ...
            fdf && paramArray.push("fdf=" + encodeURIComponent(fdf)),
              (string = paramArray.join("&")) && (string = "#" + string);
          }
          return string;
        })(pdfOpenParams)),
